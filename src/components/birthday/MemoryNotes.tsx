    ...
    <section className="relative w-full py-16 sm:py-28 px-4 sm:px-6 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-sm sm:text-base text-mau-lavender/80 font-sans max-w-md mx-auto leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start min-h-[420px]">
            ...
            <div className="w-full md:w-5/12 flex flex-col">
              <div className="flex items-center justify-between pb-4 mb-4 border-b border-mau-border/40">
                <span className="font-serif text-xs font-semibold tracking-widest text-mau-cream/70 uppercase">
                  My Notes ({notes.length})
                </span>
                <button
                  type="button"
                  onClick={handleStartCreate}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-mau-rose/15 border border-mau-rose/30 text-mau-rose text-xs font-medium hover:bg-mau-rose/25 transition cursor-pointer"
                >
              ...
              {isLoading ? (
                <div className="py-12 text-center text-xs text-mau-lavender/50 font-sans">
                  Loading notes…
                </div>
              ) : notes.length === 0 ? (
                /* Empty State */
                <div className="py-12 px-4 text-center flex flex-col items-center">
                  <Feather className="w-8 h-8 text-mau-gold/40 mb-3" />
                  <p className="font-serif text-base text-mau-cream/90 mb-1">
                    A little space for your thoughts.
                  </p>
                  <p className="text-xs text-mau-lavender/70 font-sans mb-5 max-w-xs">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          <span className="text-[10px] text-mau-gold/70 font-sans shrink-0 flex items-center gap-1">
                            <Calendar className="w-2.5 h-2.5" />
                            {formatDate(note.updatedAt)}
                          </span>
                        </div>
                        <p className="text-xs text-mau-lavender/70 font-sans line-clamp-2 leading-relaxed">
            ...
            <div className="w-full md:w-7/12 flex flex-col justify-between min-h-[380px] rounded-2xl bg-[#fffdfa]/5 border border-mau-border/40 p-5 sm:p-6 relative">
              <AnimatePresence mode="wait">
                {isEditing ? (
                  ...
                  >
                    <div className="flex items-center justify-between pb-2 border-b border-mau-border/30">
                      ...
                      <button
                        ...
                        className="text-mau-cream/50 hover:text-mau-cream text-xs p-1"
                        aria-label="Cancel"
                      >
                        <X className="w-4 h-4" />
                      </button>
                    ...
                    <input
                      ...
                      maxLength={120}
                      className="w-full bg-transparent font-serif text-lg sm:text-xl font-bold text-mau-cream placeholder-mau-cream/30 border-none outline-none"
                    />
                    ...
                    <textarea
                      ...
                      rows={8}
                      className="w-full bg-transparent font-sans text-sm text-mau-cream/90 placeholder-mau-cream/30 border-none outline-none resize-none leading-relaxed flex-1"
                    />
                    ...
                    <div className="flex items-center justify-end gap-3 pt-3 border-t border-mau-border/30">
                      <button
                        type="button"
                        onClick={handleCancel}
                        className="px-4 py-2 text-xs font-sans text-mau-cream/70 hover:text-mau-cream transition"
                      >
                        Cancel
                      </button>
                      <button
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between pb-3 mb-4 border-b border-mau-border/30">
                        <span className="text-[11px] font-sans text-mau-gold/80 flex items-center gap-1.5">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1.5 rounded-lg text-mau-cream/70 hover:text-mau-cream hover:bg-mau-surface/60 transition"
                      ...
                      <p className="font-sans text-sm sm:text-base text-mau-cream/85 leading-relaxed whitespace-pre-wrap">
                      ...
                      <div className="mt-6 p-3 rounded-xl bg-rose-950/60 border border-rose-500/40 flex items-center justify-between gap-3 text-xs">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-2.5 py-1 text-mau-cream/70 hover:text-mau-cream"
                          >
                            Keep
                          </button>
                          <button
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center py-16 text-mau-lavender/60">
                    <BookOpen className="w-8 h-8 text-mau-rose/40 mb-3" />
                    <p className="font-serif text-sm text-mau-cream/80">Select a note to read,</p>
                    <p className="text-xs text-mau-lavender/60 mt-1">or create a new memory above.</p>
                  </div>
                )}
              </AnimatePresence>
            </div>
